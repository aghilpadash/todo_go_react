...
const TodoList = () => {
    ...
    const handleFormSubmit = (todo) => {
        ...
        message.success('تسک جدید اضافه شد');
    };
    ...
    const handleToggleTodoStatus = (todo) => {
        ...
        ;
        message.info('وضعیت تسک آپدیت شد');
    };
                    ...
                    <Row>
                        <Col span={14} offset={5}>
                            ...
                            <Tabs defaultActiveKey="all">
                                ...
                                <TabPane tab="فعال" key="active">
                                    <TodoTab todos={activeTodos} onTodoToggle={handleToggleTodoStatus}
                                             onTodoRemoval={handleRemoveTodo}/>
                                </TabPane>
                                <TabPane tab="انجام شده" key="complete">
                                    <TodoTab todos={completeTodos} onTodoToggle={handleToggleTodoStatus}
                                             onTodoRemoval={handleRemoveTodo}/>
                                </TabPane>
                            </Tabs>
                        </Col>
